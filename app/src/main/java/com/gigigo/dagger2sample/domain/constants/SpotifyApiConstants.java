package com.gigigo.dagger2sample.domain.constants;

/**
 * Created by santiago.berrocoso on 16/06/2015.
 *
...
public class SpotifyApiConstants {
  ...
  public static final String ARTIST_SEARCH_URL =
      VERSION_PATH + SEARCH_PATH + "?" + TYPE_QUERY + "=" + ARTIST;
}
